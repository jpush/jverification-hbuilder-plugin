...
public class JConstants {
    ...
    public static final String setCheckedImgPathFromJs = "setCheckedImgPathFromJs";
    public static final String setUncheckedImgPathFromJs = "setUncheckedImgPathFromJs";

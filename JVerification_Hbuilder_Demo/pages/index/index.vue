			...
			setCustomUIWithConfig:function(){
				...
				if(uni.getSystemInfoSync().platform == "ios"){
					this.jv.setCustomUIWithConfigiOS({
						...
						logBtnImgs:["static/login.png","static/login.png","static/login.png"],
						agreementAlertViewLogBtnImgs:["static/login.png","static/login.png","static/login.png"],
						// agreementAlertViewBackgroundImage:'static/big.jpg',
						agreementAlertViewBackgroundColor:0xffe6e6fA,
						agreementAlertViewTitleTextFontSize:12,
						agreementAlertViewTitleTextColor:0xff000000,
						agreementAlertViewContentTextAlignment:0,
						agreementAlertViewContentTextFontSize:10,
						agreementAlertViewLogBtnText:'同意',
						agreementAlertViewLogBtnTextFontSize:12,
						agreementAlertViewLogBtnTextColor:0xff000000,

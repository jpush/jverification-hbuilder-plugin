...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/index"],{3584:function(t,n,i){"use strict";(function(t,i){Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var e=t.requireNativePlugin("JIGUANG-JVerification"),o={data:function(){return{title:"Hello",token:"",jv:e}},onLoad:function(){},methods:{onClick:function(){var n=t.requireNativePlugin("DCloud-RichAlert");n.show({position:"bottom",title:"提示信息",titleColor:"#FF0000",content:"<a href='https://uniapp.dcloud.io/' value='Hello uni-app'>uni-app</a> 是一个使用 Vue.js 开发跨平台应用的前端框架!\n免费的\n免费的\n免费的\n重要的事情说三遍",contentAlign:"left",checkBox:{title:"不再提示",isSelected:!0},buttons:[{title:"取消"},{title:"否"},{title:"确认",titleColor:"#3F51B5"}]},function(t){console.log(i(t," at pages/index/index.vue:53"))})},debug:function(){this.jv.setDebugMode(!0)},init:function(){var t=this;t.jv.init(function(n){t.showModal("init",JSON.stringify(n))})},initTimeOut:function(){var t=this;t.jv.initTimeOut(6e3,function(n){t.showModal("initTimeOut",JSON.stringify(n))})},isInitSuccess:function(){var t=this;t.jv.isInitSuccess(function(n){t.showModal("isInitSuccess",JSON.stringify(n))})},checkVerifyEnable:function(){var t=this;t.jv.checkVerifyEnable(function(n){t.showModal("checkVerifyEnable",JSON.stringify(n))})},getToken:function(){var t=this;t.jv.getToken(5e3,function(n){t.showModal("getToken",JSON.stringify(n)),2e3==n.code?t.token="token = "+n.content:t.token="[".concat(n.code,"]message=").concat(n.content)})},preLogin:function(){var t=this;t.jv.preLogin(5e3,function(n){t.showModal("preLogin",JSON.stringify(n))})},clearPreLoginCache:function(){this.jv.clearPreLoginCache()},loginAuth:function(){var t=this;t.jv.loginAuth({autoFinish:!0,timeOut:5e3},function(n){t.showModal("preLogin",JSON.stringify(n))},function(t){console.log(i("preLoginevent:"+JSON.stringify(t)," at pages/index/index.vue:120"))})},setCustomUIWithConfig:function(){this.jv.setCustomUIWithConfig({navColor:4278190080,logBtnText:" 登录 HbuilderDemo",appPrivacyColor:[4278190080,4278190080]})},showModal:function(n,i){t.showModal({title:n,content:i})}}};n.default=o}).call(this,i("6e42")["default"],i("0de9")["default"])},4231:function(t,n,i){"use strict";i.r(n);var e=i("3584"),o=i.n(e);for(var u in e)"default"!==u&&function(t){i.d(n,t,function(){return e[t]})}(u);n["default"]=o.a},"85a7":function(t,n,i){"use strict";var e=function(){var t=this,n=t.$createElement;t._self._c},o=[];i.d(n,"a",function(){return e}),i.d(n,"b",function(){return o})},"89e9":function(t,n,i){},"95db":function(t,n,i){"use strict";(function(t){i("c377"),i("921b");e(i("66fd"));var n=e(i("ddd3"));function e(t){return t&&t.__esModule?t:{default:t}}t(n.default)}).call(this,i("6e42")["createPage"])},b8a5:function(t,n,i){"use strict";var e=i("89e9"),o=i.n(e);o.a},ddd3:function(t,n,i){"use strict";i.r(n);var e=i("85a7"),o=i("4231");for(var u in o)"default"!==u&&function(t){i.d(n,t,function(){return o[t]})}(u);i("b8a5");var c=i("2877"),a=Object(c["a"])(o["default"],e["a"],e["b"],!1,null,null,null);n["default"]=a.exports}},[["95db","common/runtime","common/vendor"]]]);
});

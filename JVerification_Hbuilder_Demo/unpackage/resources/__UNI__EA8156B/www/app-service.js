...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/index"],{3584:function(t,n,i){"use strict";(function(t,i){Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var o=t.requireNativePlugin("JIGUANG-JVerification"),e={data:function(){return{title:"Hello",msg:"",jv:o}},onLoad:function(){},methods:{debug:function(){this.jv.setDebugMode(!0)},init:function(){var t=this;t.jv.init({timeout:7e3,isProduction:!1},function(n){t.showModal("init",JSON.stringify(n))})},isInitSuccess:function(){var t=this;t.jv.isInitSuccess(function(n){t.showModal("isInitSuccess",JSON.stringify(n))})},checkVerifyEnable:function(){var t=this;t.jv.checkVerifyEnable(function(n){t.showModal("checkVerifyEnable",JSON.stringify(n))})},getToken:function(){var t=this;t.jv.getToken(5e3,function(n){t.showModal("getToken",JSON.stringify(n))})},preLogin:function(){var t=this;t.jv.preLogin(5e3,function(n){t.showModal("preLogin",JSON.stringify(n))})},clearPreLoginCache:function(){this.jv.clearPreLoginCache()},loginAuth:function(){var t=this;t.jv.loginAuth({autoFinish:!0,timeout:5e3},function(n){t.showModal("loginAuth",JSON.stringify(n))},function(t){console.log(i("loginAuthevent:"+JSON.stringify(t)," at pages/index/index.vue:87"))})},setCustomUIWithConfig:function(){"ios"==t.getSystemInfoSync().platform?this.jv.setCustomUIWithConfigiOS({navColor:4278190080,logBtnText:" 极光认证测试 ",privacyState:!0,appPrivacyColor:[4278190080,4278190080]}):this.jv.setCustomUIWithConfigAndroid({setNavColor:4278190080,setLogBtnText:" 极光认证测试 ",setPrivacyState:!1,setAppPrivacyColor:[4278251520,4278190080]})},setCustomDialog:function(){"ios"==t.getSystemInfoSync().platform?this.jv.setCustomUIWithConfigiOS({navColor:4278190080,logBtnText:" 极光认证测试 ",privacyState:!0,appPrivacyColor:[4278190080,4278190080],showWindow:!0,windowConstraints:[500,500,0,0]}):this.jv.setCustomUIWithConfigAndroid({setNavColor:4278190080,setLogBtnText:" 极光认证测试 ",setPrivacyState:!1,setAppPrivacyColor:[4278251520,4278190080],setDialogTheme:[360,600,0,0,!1]})},showModal:function(n,i){t.showModal({title:n,content:i}),this.msg="".concat(n," :").concat(i)}}};n.default=e}).call(this,i("6e42")["default"],i("0de9")["default"])},4231:function(t,n,i){"use strict";i.r(n);var o=i("3584"),e=i.n(o);for(var s in o)"default"!==s&&function(t){i.d(n,t,function(){return o[t]})}(s);n["default"]=e.a},"524c":function(t,n,i){"use strict";var o=function(){var t=this,n=t.$createElement;t._self._c},e=[];i.d(n,"a",function(){return o}),i.d(n,"b",function(){return e})},"89e9":function(t,n,i){},"95db":function(t,n,i){"use strict";(function(t){i("c377"),i("921b");o(i("66fd"));var n=o(i("ddd3"));function o(t){return t&&t.__esModule?t:{default:t}}t(n.default)}).call(this,i("6e42")["createPage"])},b8a5:function(t,n,i){"use strict";var o=i("89e9"),e=i.n(o);e.a},ddd3:function(t,n,i){"use strict";i.r(n);var o=i("524c"),e=i("4231");for(var s in e)"default"!==s&&function(t){i.d(n,t,function(){return e[t]})}(s);i("b8a5");var a=i("2877"),c=Object(a["a"])(e["default"],o["a"],o["b"],!1,null,null,null);n["default"]=c.exports}},[["95db","common/runtime","common/vendor"]]]);
});

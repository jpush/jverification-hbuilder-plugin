...
UNI_EXPORT_METHOD(@selector(show:callback:))
UNI_EXPORT_METHOD(@selector(dismiss))
...
- (void)_show:(NSDictionary *)options callback:(UniModuleKeepAliveCallback)callback
{
